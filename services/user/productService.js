        ...
        if (wishlist && wishlist.products) {
            for (let i = 0; i < wishlist.products.length; i++) {
                ...
                if (variant && variant.images && variant.images.length > 0) {
                    ...
                    const fallbackVariant = await variantModel.findOne({ productId: product._id });
                    if (fallbackVariant && fallbackVariant.images && fallbackVariant.images.length > 0) {
                ...
                wishlistItems.push({
                    ...
                    name: displayName,
                    description: product ? product.description : 'Product details are no longer available.',
